    ...
    Column(modifier = Modifier.fillMaxWidth()) {
        ...
        if (!vm.invitado && vm.codigoAula != "?") {
            ListItem(
                ...
                leadingContent = { Icon(Icons.Default.Edit, contentDescription = null, tint = Azul) },
            ...
            ListItem(
                ...
                leadingContent = { Icon(Icons.Default.Timer, contentDescription = null, tint = Azul) },
                modifier = Modifier.menuClickable {
                    onCerrar()
                    onTiempo()
                }
            ...
            if (vm.numAulas < vm.MAX_AULAS) {
                ListItem(
                    ...
                    leadingContent = { Icon(Icons.Default.AddCircle, contentDescription = null, tint = Azul) },
                    modifier = Modifier.menuClickable {
                        onCerrar()
                        vm.anyadirAula()
                    }
            ...
            if (vm.numAulas > 1) {
                ListItem(
                    ...
                    leadingContent = { Icon(Icons.Default.Delete, contentDescription = null, tint = Rojo) },
                    modifier = Modifier.menuClickable {
                        onCerrar()
                        onBorrar()
                    }
            ...
            ListItem(
                ...
                leadingContent = { Icon(Icons.Default.Link, contentDescription = null, tint = Azul) },
                modifier = Modifier.menuClickable {
                    onCerrar()
                    onConectar()
                }
            ...
            ListItem(
                ...
                leadingContent = { Icon(Icons.Default.Cancel, contentDescription = null, tint = Rojo) },
                modifier = Modifier.menuClickable {
                    onCerrar()
                    vm.desconectarAula()
                }
