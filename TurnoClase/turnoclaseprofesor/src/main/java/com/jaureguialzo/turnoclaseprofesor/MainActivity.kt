            ...
            TurnoClaseProfesorTheme {
                ...
                if (vm.mostrarAlertaErrorConexion) {
                    AlertDialog(
                        ...
                        title = { Text(stringResource(R.string.dialogo_error_titulo)) },
                        text = { Text(stringResource(R.string.dialogo_error_mensaje)) },
                        confirmButton = {
                            TextButton(onClick = { vm.mostrarAlertaErrorConexion = false }) {
                ...
                if (mostrarDialogoBorrar) {
                    AlertDialog(
                        ...
                        title = { Text(stringResource(R.string.dialogo_confirmar_borrado_titulo)) },
                        text = { Text(stringResource(R.string.dialogo_confirmar_borrado_mensaje)) },
                        confirmButton = {
                            Button(
                                onClick = {
                                ...
                                Text(stringResource(R.string.dialogo_confirmar_borrado_boton), color = Color.White)
                            }
                        },
                        dismissButton = {
